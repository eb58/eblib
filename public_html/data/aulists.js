var auListQuests = [
  ...
  {'au_question_id': 47, 'qnumber': '02', 'qtext': 'Sind Maßnahmen zur Sicherung des Behandlungserfolges erforderlich (z.B. ärztliche Behandlung, Rehabilitation)?'},
  {'au_question_id': 48, 'qnumber': '03', 'qtext': 'Liegen die medizinischen Voraussetzungen zur Anwendung des § 51 Abs. 1 SGB V vor?'},
  {'au_question_id': 49, 'qnumber': '04', 'qtext': 'Besteht ein Zusammenhang mit früheren AU-Zeiten? (Gilt nur bei Geschäftsvorfall Begutachtungsauftrag zur/zum Arbeitsunfähigkeit/ Krankengeld – Anfrage Zusammenhängigkeit AU)'},
  {'au_question_id': 50, 'qnumber': '05', 'qtext': 'Fragen zum Leistungsbild'},
  {'au_question_id': 51, 'qnumber': '06', 'qtext': 'Stufenweise Wiedereingliederung nach § 74 SGB V'},
  {'au_question_id': 52, 'qnumber': '07', 'qtext': 'Besteht Arbeitsunfähigkeit? (Zweifel des Arbeitgebers)'},
  {'au_question_id': 53, 'qnumber': '08', 'qtext': 'Besteht Arbeitsunfähigkeit? (Zweifel des Jobcenters)'},
  {'au_question_id': 54, 'qnumber': '93', 'qtext': 'Sonstige Fragestellung 93'},
  {'au_question_id': 55, 'qnumber': '94', 'qtext': 'Sonstige Fragestellung 94'},
  {'au_question_id': 56, 'qnumber': '95', 'qtext': 'Sonstige Fragestellung 95'},
  {'au_question_id': 57, 'qnumber': '96', 'qtext': 'Sonstige Fragestellung 96'},
  {'au_question_id': 58, 'qnumber': '97', 'qtext': 'Sonstige Fragestellung 97'},
  {'au_question_id': 59, 'qnumber': '98', 'qtext': 'Sonstige Fragestellung 98'},
