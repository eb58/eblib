  ...
  "himi": {
    "himis": [{
      ...
      },
      {
        ...
        "digital": false,
        "qas": [
          {"id": 1, "question-id": 1, "question-number": '01', "question-text": "Ist das beantragte Hilfsmittel medizinisch notwendig?", "answer-id": 2, "answer-number": '2', "answer-text": 'Nein', "motivation": 'Pflege  bla bla bla'},
          {"id": 2, "question-id": 5, "question-number": '05', "question-text": "Ist der therapeutische Nutzen des beantragten Hilfsmittels nachgewiesen?", "answer-id": 1, "answer-number": '1', "answer-text": 'Ja', "motivation": 'Pflege bla bla bla'}
        ]
      },
      {
        "id": 2,
        ...
        "digital": false,
        "qas": [
          {"id": 1, "question-id": 1, "question-number": '01', "question-text": "Ist das beantragte Hilfsmittel medizinisch notwendig?", "answer-id": 3, "answer-number": '3', "answer-text": 'Andere Antwort', "motivation": 'Krückstock bla bla bla'},
          {"id": 2, "question-id": 4, "question-number": '09', "question-text": "Ist das vorhandene Hilfsmitel gebrauchsfähig (Evaluation gemäß § 275 Abs. 3 Sartz 3 SGB V)?", "answer-id": 1, "answer-number": '1', "answer-text": 'Ja', "motivation": 'Krückstock bla bla bla'}
        ]
      }
    ],
    "global-answer-id": '1',
