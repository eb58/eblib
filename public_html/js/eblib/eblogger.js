/* global _ */
var eblogger = function (opts) {

   var defopts = {
      onlog: console.log,
      level: eblogger.LEVEL.INFO,
   ...
   var levelStrings = Object.keys(eblogger.LEVEL).map(function (s) { // ~ ['FATAL', 'ERROR', 'WARN ', 'INFO ', 'DEBUG', 'TRACE']
      return (s + '  ').slice(0,5);
   });
   ...
   return {
      fatal: log(eblogger.LEVEL.FATAL),
      error: log(eblogger.LEVEL.ERROR),
      warn: log(eblogger.LEVEL.WARN),
      info: log(eblogger.LEVEL.INFO),
      debug: log(eblogger.LEVEL.DEBUG),
      trace: log(eblogger.LEVEL.TRACE)
   };
};

eblogger.LEVEL = {FATAL: 0, ERROR: 1, WARN: 2, INFO: 3, DEBUG: 4, TRACE: 5};
